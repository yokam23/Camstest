...
public class ValidateTicketRestoral extends BaseClass{
...
//		LogOutUsers.LogoutOperator();
		...
		TCPRequest.sendTCPReq("10.10.10.212", 5558, RequestFile.
				generateRequest(PanelId, Alert, Zone, DateTimeFunctions.GenerateOffsetDateMMDDYYYY(0), 
						DateTimeFunctions.GenerateOffsetTimeHHMMSS()));
