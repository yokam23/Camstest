...
public class DeleteManufacturer extends BaseClass {
	...
	@Test(description = "TC0001::Validate Delete Manufacturer", groups = { "UI" }, dataProvider = "DataReader")
	public void validateDeleteManufacturer(String TCNo, String Description, String companyName) throws Throwable {
		TCName.append(TCNo);
		...
		manufacturer.DeleteManufacturer(companyName);
