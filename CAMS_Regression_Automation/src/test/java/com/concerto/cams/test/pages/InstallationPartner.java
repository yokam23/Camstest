...
public class InstallationPartner {
	...
	@FindBy(xpath = "//h2[text()='Installation Partner']")
	...
	@FindBy(xpath = "//div[@class='modal-body']//input[@id='txtAgencyAddress']")
	...
	@FindBy(xpath = "//div[@class='modal-footer']//input[@id='btnaddAgency']")
	...
	@FindBy(xpath = "//input[@placeholder='Search by Company Name,Mobile No,Contact Person Name']")
	...
	@Name(Description = "Validation message for company name")
	@FindBy(xpath = "//div[@class='modal-content']//span[@id='errorIsValidAgencyName']")
	public WebElement Validation_companyName;

	@Name(Description = "Validation message for company address")
	@FindBy(xpath = "//div[@class='modal-content']//span[@id='errorIsValidAgencyAddress']")
	public WebElement Validation_companyaddress;
