...
public class Servicepartner {
	...
	@FindBy(xpath = "//h2[text()='Service Partner']")
	...
	@Name(Description = "Validation message for Contactperson")
	@FindBy(xpath = "//div[@class='modal-body']//span[@id='errorIsValidContactPersone']")
	public WebElement Validation_Contactperson;

	@Name(Description = "Validation message for Mobileno")
	@FindBy(xpath = "//div[@class='modal-body']//span[@id='errorIsValidMobileNo']")
	public WebElement Validation_MobileNo;
