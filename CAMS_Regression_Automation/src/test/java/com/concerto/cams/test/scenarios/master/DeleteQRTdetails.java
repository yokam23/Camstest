...
public class DeleteQRTdetails extends BaseClass {
	...
	@Test(description = "TC0001:To Delete QRT agency", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteQRTdetails(String TCNo, String Description, String Searchtxt) throws Throwable {
		TCName.append(TCNo);
		...
		qrtutils.DeleteQRTAgency(Searchtxt);
