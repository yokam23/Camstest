...
public class DeleteServicePartner extends BaseClass {
	...
	@Test(description = "TC0001:To Delete Service partner", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteServicePartner(String TCNo, String Description, String Searchtxt) throws Throwable {
		TCName.append(TCNo);
		...
		SPutils.DeleteServicepartnerdetails(Searchtxt);
