...
public class EditCRAAgency extends BaseClass {
	...
	@Test(description = "TC0001::Validate Edit CRA agency details", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateEditCRAAgency(String TCNo, String Description, String CompanyName, String CompanyAddress,
		...
		crautils.EditCRAAgency(CompanyName, CompanyAddress, Emailid, MobileNo);
		...
		Asserts.assertEqual(MasterDBDetails.GetAgencyDetails(CompanyName, "CRA").get(0).get("MobileNo"),MobileNo , "Correct MobileNo name displayed in database");	
		Asserts.assertEqual(MasterDBDetails.GetAgencyDetails(CompanyName, "CRA").get(0).get("EmailID"),Emailid , "Correct EmailID name displayed in database");
