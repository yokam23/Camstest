...
public class DeleteNationalHolidayDetails extends BaseClass {
	...
	@Test(description = "TC0001::Validate to delete national details", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateEditNationalHoliday(String TCNo,String Description, String Searchtxt) throws Throwable {
		TCName.append(TCNo);
		...
		NHpageutils.DeleteNationalHolidayRecord(Searchtxt);
