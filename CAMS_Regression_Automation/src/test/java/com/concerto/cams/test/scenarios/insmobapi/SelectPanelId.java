...
public class SelectPanelId extends BaseClass{
	...
	@Test(description = "TC0002::Validate select client in installation tool ", groups = { "API" }, dataProvider = "DataReader")
    public void ValidateSelectPanelId(String TCNo, String Description,String loginId,String Password,String clientName,String panelId,String deviceId) throws Throwable{
		...
		String Json = InstallationselectPanelId.selectPanelId(loginId, clientName, panelId, sessionId);
		
		Response response = RestMethods.POST_Request("http://10.10.10.212:8080/InstallationTool/", "selectPanelId", "", Json);
