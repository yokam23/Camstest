...
import com.concerto.cams.test.api.json.MoveToQCDescription;
...
public class INSMoveToQCDescription extends BaseClass {
	String ClassName;
	String PackageName;
	...
	@Test(description = "TC0001::Validate Panel Move To QC in installtion tool ", groups = { "API" }, dataProvider = "DataReader")
    public void ValidateMoveToQCDescription(String TCNo, String Description,String loginId,String Password,String deviceId, String clientName, String panelId,String tracking, String pingStatusTime, 
    		String pingStatusTtl,String sensorStatus, String sensorType, String zoneNo, String remark, String previousMode, String previousCircle) 
    				throws Throwable{
		...
		Response PanelTrackingresponse = RestMethods.POST_Request("http://10.10.10.212:8080/InstallationTool/", "panelTracking", "", PanelIdJson);
		
		String Json = MoveToQCDescription.MoveToQC(loginId, clientName, panelId, pingStatusTime, pingStatusTtl, sensorStatus, sensorType, zoneNo, remark, previousMode, previousCircle, sessionId);
		
		Response response = RestMethods.POST_Request("http://10.10.10.212:8080/InstallationTool/", "description", "", Json);
