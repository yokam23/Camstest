...
public class DeleteTerritory extends BaseClass {
	...
	@Test(description = "TC0001:To Delete territory details", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteTerritroy(String TCNo, String Description, String searchtext) throws Throwable {
		TCName.append(TCNo);
		...
		TMutils.DeleteTerritoryManagerVendor(searchtext);
