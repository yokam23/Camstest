...
public class TestToQuality extends BaseClass{
	...
	@Test(description = "TC0001::Validate Change Panel Mode Test To Quality In System Maintainance",groups = { "UI" },dataProvider="DataReader")
	public void validateTestToQuality(String TCNo, String SelectClient, String SelectLeft, String DualLoginID, String Password,
		...
		SystemMaintainancePageUtils.TestToQuality(SelectClient,SelectLeft, DualLoginID, Password, Comments, SelectCircle);
