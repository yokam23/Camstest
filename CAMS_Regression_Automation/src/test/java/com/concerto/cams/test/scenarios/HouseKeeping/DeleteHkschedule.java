...
public class DeleteHkschedule extends BaseClass {
	...
	@Test(description = "TC0001::To delete the added schedule", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteSchedule(String TCNo, String Description, String ClientName, String PoolName,
		...
		if (Switch.equalsIgnoreCase("Deletion")) {
			hkschedule.DeleteSchedule(ClientName, PoolName);
		}
