...
public class PanelReports extends BaseClass {
	...
	public void validateAddCity(String TCNo, String Description,String ReportName, String PanelId, String ClientId,
			String RouterModel,String NetworkType,String NetworkProvider)
			throws Throwable {
		TCName.append(TCNo);
		...
		if(ReportName.equalsIgnoreCase("Alarm Panel not Responding")) {
			ReportPageUtils.validatePanelNotResponding(PanelId, ClientId, RouterModel, NetworkType, NetworkProvider);
		}else {
		ReportPageUtils.validateAlarmPanel(PanelId, ClientId);
		}
