...
public class DeleteNetworkProvider extends BaseClass {
	...
	@Test(description = "TC0001:To delete network provider", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteNetworkprover(String TCNo, String Description, String Searchtxt) throws Throwable {
		TCName.append(TCNo);
		...
		nputils.DeleteNetworkprovider(Searchtxt);
