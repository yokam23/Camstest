...
public class DeleteCRAAgency extends BaseClass {
	...
	public void ValidateDeleteCRAAgency(String TCNo, String Description, String Searchtxt) throws Throwable {
		TCName.append(TCNo);
		...
		crautils.DeleteCRAAgencydetails(Searchtxt);
