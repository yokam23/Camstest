...
public class DeleteSensordetails extends BaseClass {
	...
	@Test(description = "TC0001::Validate to Delete sensor details", groups = { "UI" }, dataProvider = "DataReader")
	public void validateDeleteSensor(String TCNo, String Description, String Sensortype) throws Throwable {
		TCName.append(TCNo);
		...
		sensor.Deletesensor(Sensortype);
