...
public class EditInstallationPartner extends BaseClass {
	...
	@Test(description = "TC0001:To Edit Installation partner", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateEditInstallationPartner(String TCNo, String Description, String CompanyName,
			String CompanyAddress, String Emailid, String MobileNo) throws Throwable {
		TCName.append(TCNo);
		...
		IPutils.EditInstallationpartner(CompanyName, CompanyAddress, Emailid, MobileNo);
