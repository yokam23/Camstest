...
public class DeleteClient extends BaseClass{
	...
	@Test(description = "TC0001::Validate delete Client for Valid Data",groups = { "UI" },dataProvider="DataReader")
	public void ValidateDeleteClient(String TCNo,String SearchClient) throws Throwable {
		TCName.append(TCNo);
		...
		ClientPageUtils.DeleteClient(SearchClient);
