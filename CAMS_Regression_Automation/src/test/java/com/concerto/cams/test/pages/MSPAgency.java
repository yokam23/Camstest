...
public class MSPAgency {
	
	@Name(Description="Page Header")
	@FindBy(xpath="//h2[text()='MSP Vendors']")
	...
	@FindBy(xpath = "//div[@class='modal-footer']//input[@id='btnaddMSPVendor']")
	...
	@FindBy(xpath = "//input[@placeholder='Search by Company Name,Mobile No,Contact Person']")
	...
	@Name(Description = "Validation for Pin code field")
	@FindBy(xpath = "//div[@class='modal-content']//span[@id='errorIsValidPinCode']")
	public WebElement Validation_Pincode;
	
	@Name(Description ="Validation for Contact person")
	@FindBy(xpath = "//div[@class='modal-content']//span[@id='errorIsValidContactPersone']")
	public WebElement Validation_contactPerson;
