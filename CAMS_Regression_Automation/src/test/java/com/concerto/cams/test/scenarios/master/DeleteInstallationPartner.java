...
public class DeleteInstallationPartner extends BaseClass {
	...
	@Test(description = "TC0001:To Delete Installation partner", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteInstallationPartner(String TCNo, String Description, String Searchtxt) throws Throwable {
		TCName.append(TCNo);
        ...
        IPutils.DeleteInstallationVendor(Searchtxt);
