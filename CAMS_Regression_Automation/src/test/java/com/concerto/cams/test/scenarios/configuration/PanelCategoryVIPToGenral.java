...
public class PanelCategoryVIPToGenral extends BaseClass{
	...
	@Test(description = "TC0001::Validate  Change panel category from  VIP to Genral for Valid Data",groups = { "UI" },dataProvider="DataReader")
	public void validateAddDealer(String TCNo, String SearchPanel) throws Throwable {
		 ...
		 * Panel Category
		 */
		PanelCategoryPageUtils.navigateToPanelCategoryVIPToGenral();
		PanelCategoryPageUtils.PanelCategoryVIPToGenral(SearchPanel);
