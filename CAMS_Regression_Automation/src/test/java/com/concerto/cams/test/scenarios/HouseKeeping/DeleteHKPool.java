...
public class DeleteHKPool extends BaseClass {
	...
	@Test(description = "TC0001::Validate Delete House keeping pool ", groups = { "UI" }, dataProvider = "DataReader")
    public void ValidateDeletePool(String TCNo,String Description,String ClientName,String PoolName) throws Throwable {
		TCName.append(TCNo);
		...
		poolutils.DeletePoolRecord(PoolName);
