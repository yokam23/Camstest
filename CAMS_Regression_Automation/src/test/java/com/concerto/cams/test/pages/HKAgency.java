...
public class HKAgency {
	
	@Name(Description="Page Header")
	@FindBy(xpath="//h2[text()='House Keeping Agency']")
    ...
    @Name(Description = "Validation message for State name")
    @FindBy(xpath = "//div[@class='modal-content']//span[@id='errorIsValidstate']")
    public WebElement Validation_StateField;
