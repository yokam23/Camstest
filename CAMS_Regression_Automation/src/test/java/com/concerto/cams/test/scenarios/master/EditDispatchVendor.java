...
public class EditDispatchVendor extends BaseClass {
	...
	@Test(description = "TC0001::Validate Edit Dispatch vendor", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateEditDispatchVendor(String TCNo, String Description, String CompanyName, String State,
			String City, String Pincode) throws Throwable {
		TCName.append(TCNo);
		...
		dispatch.EditNewvendor(CompanyName, State, City, Pincode);
