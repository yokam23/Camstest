...
public class INSPanelTracking extends BaseClass {
	...
	@Test(description = "TC0001::Validate Start/stop Panel Tracking in installtion tool ", groups = { "API" }, dataProvider = "DataReader")
    public void ValidateStartPanelTracking(String TCNo, String Description,String loginId,String Password,String deviceId,String clientName,String panelId,String tracking,String Switch) throws Throwable{
		...
		String Json = InstallationPanelTracking.StartPanelTracking(loginId, clientName, panelId, tracking, sessionId);
		
		if(Switch.equalsIgnoreCase("panelTracking")) {
		response = RestMethods.POST_Request("http://10.10.10.212:8080/InstallationTool/", "panelTracking", "", Json);	
		}else if(Switch.equalsIgnoreCase("panelTracking")) {
		response = RestMethods.POST_Request("http://10.10.10.212:8080/InstallationTool/", "panelTracking", "", Json);
		}
