...
public class AllocateSite extends BaseClass {
	...
	public void ValidateAllocateSites(String TCNo, String Description,String ClientName,String Poolname,String cameraNo,String Switch) throws Throwable {
		TCName.append(TCNo);
		...
		if(Switch.equalsIgnoreCase("Allocatesite")) {
		siteutils.AllocateSites(Poolname, cameraNo);
		}else if(Switch.equalsIgnoreCase("ErrorMsg")) {
			siteutils.GetValidationMsg(Poolname);
		}else if(Switch.equalsIgnoreCase("UpdateCamera")) {
			siteutils.UpdateCameraOnViewSitepage(Poolname, cameraNo);
		}
