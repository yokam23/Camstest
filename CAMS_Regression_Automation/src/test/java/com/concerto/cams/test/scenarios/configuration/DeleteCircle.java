...
public class DeleteCircle extends BaseClass {
	...
	public void validateToDeleteCircle(String TCNo, String  CircleName) throws Throwable {
		TCName.append(TCNo);
		...
		CirclePageUtils.DeleteCircle(CircleName);
