...
public class QRTAgency {

	@Name(Description="Page Header")
	@FindBy(xpath="//h2[text()='QRT Agency']")
	...
	@Name(Description="Validation Message for email id field")
	@FindBy(xpath="//div[@class='modal-content']//span[@id='errorIsValidEmailID']")
