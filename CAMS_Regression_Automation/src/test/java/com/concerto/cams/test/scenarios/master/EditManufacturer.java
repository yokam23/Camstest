...
public class EditManufacturer extends BaseClass {
	...
	@Test(description = "TC0001::Validate Edit Manufacturer", groups = { "UI" }, dataProvider = "DataReader")
	public void validateEditManufacturer(String TCNo, String Description, String Devicename, String companyName,
		...
		manufacturer.EditManufacturer(Devicename, companyName, Searchtxt);
