...
public class DeleteDispatchVendor  extends BaseClass {
	...
	@Test(description = "TC0001::Validate Delete Dispatch vendor", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateDeleteDispatchVendor(String TCNo,String Description,String Searchtxt) throws Throwable {
		TCName.append(TCNo);
        ...
        dispatch.DeleteVendor(Searchtxt);
