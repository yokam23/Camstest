...
public class ViewLatestMonitoring extends BaseClass{
	...
	public void validateViewLatestMonitoring(String TcNO,String Client, String SiteID,String SiteLocation, String Location) throws Throwable {
		TCName.append(TcNO);
		 ...
		 * Monitoring 
		 */
		MonitoringPageUtils.ViewLatestMonitoring(Client, SiteID,SiteLocation, Location);
