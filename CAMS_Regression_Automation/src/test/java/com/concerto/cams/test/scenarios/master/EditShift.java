...
public class EditShift extends BaseClass {
	...
	@Test(description = "TC0001::Validate Edit shift details", groups = { "UI" }, dataProvider = "DataReader")
	public void ValidateEditShift(String TCNo, String Description, String Shiftname, String Timefrom, String Timeto,
		...
		shiftutils.EditShift(Shiftname, Timefrom, Timeto, Searchtxt);
