...
public class DeleteCity extends BaseClass {
	...
	@Test(description = "TC0001::Validate to delete city details", groups = { "UI" }, dataProvider = "DataReader")
	public void validateDeleteCity(String TCNo, String Description, String Searchtext) throws Throwable {
		TCName.append(TCNo);
		...
		CityPageUtils.DeleteCity(Searchtext);
