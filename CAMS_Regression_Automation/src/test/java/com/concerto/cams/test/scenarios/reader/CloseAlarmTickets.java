...
public class CloseAlarmTickets extends BaseClass {
	...
	@Test(description = "TC0001::CloseTicket ", groups = { "UI" })
	public void CloseTicket()throws Throwable {
		boolean status = LoginPageUtils.LaunchCams(Config.APPURL_CAMS);
		Asserts.assertTrue(status, "Launch Page Is Displayed");
		LoginPageUtils.ValidLoginToCams(Config.operatorlogin, Config.operatorpassword);
