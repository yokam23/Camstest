...
public class ReadSubscriptionId
{
...
/*
		   ...
		   public static String ReturnSubscriptionId() throws Throwable, Throwable {
			      ...
			      String Key= "Recurring Confirmation";
			      
			     String Body = checklastthirtymails(host, mailStoreType, username, password,Key);
			     System.out.println(Body);
			      String SubscriptionId = Body.split("Your subscription id is <b>")[1].split("</b>")[0];
